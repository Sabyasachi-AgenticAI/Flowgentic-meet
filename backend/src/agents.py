...
class TomAgent(GenericAgent):
    ...
    def __init__(self, chat_ctx: ChatContext = None, first_time: bool = False) -> None:
        ...
        - If the user greets you again later in the meeting, greet them back in an enthusiastic, credible, and professional manner, ask how they are, and check where they would like to pick up the agenda.
